...
SWIFT_CLASS("_TtC11LeapCoreSDK11WfxLogEntry")
...
@interface WfxLogEntry (SWIFT_EXTENSION(LeapCoreSDK))
...
SWIFT_CLASS("_TtC11LeapCoreSDK13WfxLogSession")
...
@interface WfxLogSession (SWIFT_EXTENSION(LeapCoreSDK))
