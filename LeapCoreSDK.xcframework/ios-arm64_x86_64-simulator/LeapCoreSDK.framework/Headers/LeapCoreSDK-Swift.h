...
- (void)presentInViewInstructionWithData:(NSDictionary<NSString *, NSObject *> * _Nonnull)data rect:(CGRect)rect anchorView:(UIView * _Nullable)anchorView parentScrollList:(NSArray<UIView *> * _Nullable)parentScrollList autoFocusScript:(NSString * _Nullable)autoFocusScript autoScrollScript:(NSString * _Nullable)autoScrollScript selectedLanguage:(NSString * _Nonnull)selectedLanguage;
...
- (void)updateRectWithRect:(CGRect)rect parentView:(NSArray<UIView *> * _Nullable)parentView anchorView:(UIView * _Nullable)anchorView autoScrollScript:(NSString * _Nullable)autoScrollScript;
